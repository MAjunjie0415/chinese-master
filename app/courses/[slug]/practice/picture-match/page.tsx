...
import PictureMatchClient from './PictureMatchClient';
...
export default async function PictureMatchPage({ params }: PageProps) {
  ...
  if (!session) {
    redirect(`/login?redirect=/courses/${slug}/practice/picture-match`);
  }
